...
neutron net-create dpdk0 --provider:network_type vlan --provider:segmentation_id 4071 --provider:physical_network fastpath  #(name given in Neutron bridgeMappings)
